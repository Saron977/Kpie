//
//  BYC_NationalDayViewcontroller.m
//  kpie
//
...
#import "BYC_NationalDayViewcontroller.h"
...
#define VC_CONST_COLLECTION_HEADER (277 - 40)

@interface BYC_NationalDayViewcontroller()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout> {
...
@implementation BYC_NationalDayViewcontroller
    ...
    self.collectionView.header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        switch (weakSelf.type_ActionSelect) {
            case Enum_ActionSelectTypeFocus:
            {
                ...
                [weakSelf refreshParameterWithModel:model Type:weakSelf.isFocusTag == 0 ? weakSelf.isFocusTag : 2 upType:@"0"];
            }
            ...
            case Enum_ActionSelectTypeFavorite:
            {
                ...
                [weakSelf refreshParameterWithModel:model Type:weakSelf.isFavoriteTag == 0 ? weakSelf.isFavoriteTag : 2 upType:@"0"];
            }
                break;
    ...
    self.collectionView.footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        switch (weakSelf.type_ActionSelect) {
            case Enum_ActionSelectTypeFocus:
            {
                ...
                [weakSelf refreshParameterWithModel:model Type:weakSelf.isFocusTag == 0 ? weakSelf.isFocusTag : 2 upType:@"1"];
            }
            ...
            case Enum_ActionSelectTypeFavorite:
            {
                ...
                [weakSelf refreshParameterWithModel:model Type:weakSelf.isFavoriteTag == 0 ? weakSelf.isFavoriteTag : 2 upType:@"1"];
            }
                break;
...
- (void)requestGroupWithType {
    ...
    switch (_type_ActionSelect) {
        case Enum_ActionSelectTypeFocus:
            mDic[@"type"] = [NSString stringWithFormat:@"%d",_isFocusTag == 0 ? _isFocusTag : 2];
            [self requestGroupFocus:mDic];
            break;
        case Enum_ActionSelectTypeFavorite:
            mDic[@"type"] = [NSString stringWithFormat:@"%d",_isFavoriteTag == 0 ? _isFavoriteTag : 2 ];
...
- (void)firstRequestData {
    ...
    QNWSDictionarySetObjectForKey(parameters, [NSNumber numberWithInteger:_isFocusTag == 0 ? _isFocusTag : 2], @"type")
    ...
    [BYC_HttpServers Get:KQNWS_GetGroupAllJsonArrayListVideoUrl parameters:parameters success:^(AFHTTPRequestOperation *operation,id responseObject) {
        ...
        if ([_model.isactive intValue] == 5) {//自己制造的假数据模型
            
            BYC_MTVideoGroupModel *model1= [[BYC_MTVideoGroupModel alloc] init];
            model1.videoGroup_Name = @"最新上传";
            
            BYC_MTVideoGroupModel *model2= [[BYC_MTVideoGroupModel alloc] init];
            model2.videoGroup_Name = @"总排行榜";
            [mArr addObject:model1];
            [mArr addObject:model2];
        }
        
        _topHiddenView.array_VideoGroup = mArr;
...
-(UICollectionReusableView*)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    if(kind == UICollectionElementKindSectionHeader)
    {
        ...
        _header.isHiddenView_ChangeDataType = YES;
        return _header;
    }
