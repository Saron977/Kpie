...
{
    self = [super initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, KHeightNavigationBar - KHeightStateBar)];
    if (self) {
...
- (void)buttonAction {
    ...
    [(UINavigationController *)[self getBGViewController] popViewControllerAnimated:YES];
}
