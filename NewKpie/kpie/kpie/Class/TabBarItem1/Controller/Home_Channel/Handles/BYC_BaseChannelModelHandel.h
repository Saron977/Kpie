...
@interface BYC_BaseChannelModelHandel : NSObject
...
/**数据字典*/
@property (nonatomic, strong) NSMutableDictionary <id , BYC_BaseColumnModelHandel *> *mDic_Models;
/**数据下标*/
...
/**当前选中的栏目模型处理类*/
@property (nonatomic, strong)  BYC_BaseColumnModelHandel  *handel_ColumnModels;
