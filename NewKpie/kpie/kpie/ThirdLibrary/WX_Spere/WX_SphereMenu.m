...
@interface WX_SphereMenu () <UICollisionBehaviorDelegate>
{
    int _clickCount;
...
- (void)startTapped:(UITapGestureRecognizer *)gesture
{
    QNWSLog(@"点击了BUTTON");
//    if (_clickCount == 1) {
//        _backgroundView.frame = CGRectMake(-600, -600, -600, -600);
//        _clickCount--;
//    }else if (_clickCount == 0){
//        _backgroundView.frame = CGRectMake(0, 0, self.window.frame.size.width, self.window.frame.size.height-kHeightTabBar);
//        _backgroundView.backgroundColor = [UIColor colorWithRed:42 green:62 blue:62 alpha:0.2];
