...
- (void)moveOneStep:(BOOL)isSwipingToLeftDirection {
    ...
    [self coverFlowImageSwipingWithImageIndex:self.currentRenderingImageIndex];
}
 ...
 *  代理传值图片数组中下标
 *
 *  @param imageIndex 图片数组中下标
 */
-(void)coverFlowImageSwipingWithImageIndex:(NSInteger)imageIndex
{
    [self.delegate coverFlowCurrentRenderingImageIndex:imageIndex];
}
