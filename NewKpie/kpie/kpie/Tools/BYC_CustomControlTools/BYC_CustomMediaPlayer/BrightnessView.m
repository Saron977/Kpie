...
//  BrightnessView.m
//
// Copyright (c) 2016年 axb. All rights reserved.
...
- (instancetype)init {
	if (self = [super init]) {
		...
		self.backgroundColor = [UIColor colorWithPatternImage:KImageNamed(@"brightness_bg.png")];
        
		self.backImage =  [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 79, 76)];
        self.backImage.image = KImageNamed(@"playgesture_BrightnessSun6.png");
